package com.chen.yygh.order.service.impl;
...
import com.chen.model.enums.OrderStatusEnum;
import com.chen.model.model.order.OrderInfo;
import com.chen.model.model.user.Patient;
import com.chen.model.vo.hosp.ScheduleOrderVo;
import com.chen.model.vo.msm.MsmVo;
import com.chen.model.vo.order.*;
import com.chen.rabbitutil.constant.MqConst;
import com.chen.rabbitutil.service.RabbitService;
import com.chen.serviceutil.helper.HttpRequestHelper;
import com.chen.yygh.hosp.client.HospitalFeignClient;
import com.chen.yygh.order.mapper.OrderMapper;
import com.chen.yygh.order.service.OrderService;
import com.chen.yygh.order.service.WeixinService;
import com.chen.yygh.order.utils.RandomUtil;
import com.chen.yygh.user.client.PatientFeignClient;
...
public class OrderServiceImpl extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        if (result.getInteger("code") == 200) {
            ...
            //短信提示
            sendMessage(orderInfo, orderMqVo);
        } else {
    ...
    private void sendMessage(OrderInfo orderInfo, OrderMqVo orderMqVo) {
