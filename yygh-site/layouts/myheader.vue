<template>
  <div class="header-container">
    ...
    <!-- 登录弹出层 -->
    <el-dialog :visible.sync="dialogUserFormVisible" style="text-align: left;display: none; " top="50px"
...
export default {
  ...
  methods: {
    loginCallback(name, token, openid, phone) {
      // 打开手机登录层，绑定手机号，改逻辑与手机登录一致
      if ((openid != null || openid != '') && (phone == null || phone == '')) {
    ...
    login() {
      ...
      if (this.userInfo.code.length != 6 && this.userInfo.code.length != 4) {
